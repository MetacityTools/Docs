...
| Parameter       | Required | Description                                                                                                                                                                                                                                   |
| --------------- | :------: | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `api`           |     ✅    | `string`, path to dataset exported from `Metacity` (see [Exporting data](metacity.md#exporting-data)), some sets are available through our [DataAPI](https://api.metacity.cc/), or you can use self-hosted datasets if you have your own data |
